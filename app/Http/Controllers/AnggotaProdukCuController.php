...
class AnggotaProdukCuController extends Controller{
	...
	public function history()
  {
    ...
    $table_data = Revision::with('revisionable')->where('revisionable_type','App\Models\AnggotaProdukCu')->where('created_at','>=',$time)->orderBy('created_at','desc')->get();
