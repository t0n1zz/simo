...
use File;
use Image;
use App\Models\AssesmentAccess;
...
class AssesmentAccessController extends Controller{
	...
	public function history()
  {
    ...
    $table_data = Revision::with('revisionable')->where('revisionable_type','App\Models\AssesmentAccess')->where('created_at','>=',$time)->orderBy('created_at','desc')->take(5);
