...
class CuController extends Controller{
	...
	{
		$table_data = Cu::where('id','!=',0)->select('id','name','escete','tanggal_update_data')->where('escete','1')->orderby('tanggal_update_data','desc')->get();
	...
	public function history()
  {
    ...
    $table_data = Revision::with('revisionable')->where('revisionable_type','App\Models\Cu')->where('created_at','>=',$time)->orderBy('created_at','desc')->take(5);
