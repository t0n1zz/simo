...
use App\Models\JalinanKlaimStatus;
...
class JalinanKlaimController extends Controller
{
	...
	public function history()
	{
		...
		$table_data = Revision::with('revisionable')->where('revisionable_type', 'App\Models\JalinanKlaim')->where('created_at', '>=', $time)->orderBy('created_at', 'desc')->get();
