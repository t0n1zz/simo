...
class MonitoringPencapaianController extends Controller{
	...
	{
		$request->validate(MonitoringPencapaian::$rules);
	...
	public function history()
  {
    ...
    $table_data = Revision::with('revisionable')->where('revisionable_type','App\Models\MonitoringPencapaian')->where('created_at','>=',$time)->orderBy('created_at','desc')->take(5);
