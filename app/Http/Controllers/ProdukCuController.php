...
class ProdukCuController extends Controller
{
    ...
    public function history()
    {
        ...
        $table_data = Revision::with('revisionable')->where('revisionable_type', 'App\Models\ProdukCu')->where('created_at', '>=', $time)->orderBy('created_at', 'desc')->take(5);
