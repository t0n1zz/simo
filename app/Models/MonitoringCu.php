...
class MonitoringCu extends BaseEloquent {
    ...
    {
        return $this->belongsTo('App\Models\Aktivis','id_aktivis_pic','id');
    }

    public function aktivis_pemeriksa()
    {
        return $this->belongsTo('App\Models\Aktivis','id_aktivis_pemeriksa','id');
    }

    public function monitoring_rekom()
    {
        return $this->hasMany('App\Models\MonitoringRekomCu','id_monitoring_cu','id');
    }

    public function monitoring_rekom_ok()
    {
        return $this->hasMany('App\Models\MonitoringRekomCu','id_monitoring_cu','id')->where('status',1);
    }

    public function monitoring_pencapaian()
    {
        return $this->hasMany('App\Models\MonitoringPencapaianCu','id_monitoring_cu','id');
    }

    public function monitoring_rekom_last_year()
    {
        return $this->hasMany('App\Models\MonitoringRekomCu','id_monitoring_cu','id')->select('id','id_monitoring_cu');
    }

    public function monitoring_rekom_ok_last_year()
    {
        return $this->hasMany('App\Models\MonitoringRekomCu','id_monitoring_cu','id')->select('id','id_monitoring_cu','status')->where('status',1);
    }
    ...
    {
        return $this->hasOne('App\Models\MonitoringPencapaianCu', 'id_monitoring', 'id')->orderBy('created_at', 'desc');
    }
