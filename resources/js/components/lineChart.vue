		...
		<div class="card-body">
			...
			<div class="row d-print-none">
              ...
              <div class="input-group">
								...
								<div class="input-group-prepend" v-if="dataShown.length > 1">
									<button class="btn btn-light" v-tooltip:top="'Hapus data '" @click="removeColumn(index)" :disabled="itemDataStat === 'loading'">
...
export default {
  ...
  methods: {
    ...
    addColumn() {
      ...
      this.line.series[length - 1].data = _.map(this.itemData.data, this.dataShown[0].name);
    },
    addSeries() {
