				...
				<div class="modal-show" v-if="show">
					<div class="modal-dialog" :class="size" @click.stop>
						<div class="modal-content">
							<div class="modal-header" :class="color" v-if="state === 'normal1' || state === 'normal2' || state === 'normal3' || state === 'normal4'">
							...
							<div class="modal-body">
								<transition name="modal-effect" enter-active-class="animated fadeIn" mode="out-in">
										...
										<div v-if="content">
											...
											<span>
												<span v-if="content.message">
													<pre class="pre-scrollable language-markup content-group text-left">{{ content.message }}<br/><span v-if="content.errors"><span v-for="(errors, index) in content.errors" :key="index"><span v-for="(e, index) in errors" >{{ e }} <br/></span></span></span>
													</pre>
												</span>
												<span v-else-if="content.data">
													<pre class="pre-scrollable language-markup content-group text-left">{{ content.data.message }}<br/><span v-if="content.data.errors"><span v-for="(errors, index) in content.data.errors" :key="index"><span v-for="(e, i) in errors" >{{ e }} <br/></span></span></span>
													</pre>
												</span>
									...
									<!-- normal4 -->
									<div v-else-if="state === 'normal4'" key="normal4">
										<slot name="modal-body4"></slot>
										<div class="modal-footer no-padding">
											<slot name="modal-footer4"></slot>
										</div>
									</div>
