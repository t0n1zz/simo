...
export const useArtikelKategoriStore = defineStore('artikelKategori', {
    state: () => ({
        data: {}, // single data
        dataS: [], // collection
        dataStat: '',
    ...
    actions: {
        ...
        async index(p) {
            ...
            try {
                const response = await ArtikelKategoriAPI.index(p);
        ...
        async indexCu(p, id) {
            ...
            try {
                const response = await ArtikelKategoriAPI.indexCu(p, id);
                this.dataS = response.data.model;
                this.dataStatS = 'success';
            } catch (error) {
                this.dataS = error.response;
        ...
        async get() {
            ...
            try {
                const response = await ArtikelKategoriAPI.get();
                this.dataS = response.data.model;
                this.dataStatS = 'success';
            } catch (error) {
                this.dataS = error.response;
        ...
        async getCu(id) {
            ...
            try {
                const response = await ArtikelKategoriAPI.getCu(id);
                this.dataS = response.data.model;
                this.dataStatS = 'success';
            } catch (error) {
                this.dataS = error.response;
        ...
        async create() {
            ...
            try {
                const response = await ArtikelKategoriAPI.create();
        ...
        async edit(id) {
            ...
            try {
                const response = await ArtikelKategoriAPI.edit(id);
                this.data = response.data.form;
                this.rules = response.data.rules;
                this.options = response.data.options;
                this.dataStat = 'success';
