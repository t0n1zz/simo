...
export const useAssesmentCulegStore = defineStore('assesmentCuleg', {
  state: () => ({
    data: {}, //single data
    dataS: [], //collection
    periode: {},
  ...
  actions: {
    ...
    async index(p) {
      ...
      try {
        const response = await AssesmentCulegAPI.index(p);
    ...
    async indexCu([p, id]) {
      ...
      try {
        const response = await AssesmentCulegAPI.indexCu(p, id);
        this.dataS = response.data.model;
        this.dataStatS = 'success';
      } catch (error) {
        this.dataS = error.response;
    ...
    async create() {
      ...
      try {
        const response = await AssesmentCulegAPI.create();
    ...
    async store(form) {
      ...
      try {
        const response = await AssesmentCulegAPI.store(form);
    ...
    async edit(id) {
      ...
      try {
        const response = await AssesmentCulegAPI.edit(id);
        this.data = response.data.form;
        this.rules = response.data.rules;
        this.options = response.data.options;
        this.dataStat = 'success';
    ...
    async editPenilaian(id) {
      ...
      try {
        const response = await AssesmentCulegAPI.editPenilaian(id);
        this.data = response.data.form;
        this.rules = response.data.rules;
        this.options = response.data.options;
        this.dataStat = 'success';
    ...
    async update([id, form]) {
      ...
      try {
        const response = await AssesmentCulegAPI.update(id, form);
        if (response.data.saved) {
          this.updateData = response.data;
          this.updateStat = 'success';
        } else {
    ...
    async updateSingle([id, perspektif, form]) {
      ...
      try {
        const response = await AssesmentCulegAPI.updateSingle(id, perspektif, form);
        if (response.data.saved) {
    ...
    async restore(id) {
      ...
      try {
        const response = await AssesmentCulegAPI.restore(id);
    ...
    async destroy(id) {
      ...
      try {
        const response = await AssesmentCulegAPI.destroy(id);
    ...
    async cariData([cu, periode]) {
      ...
      try {
        const response = await AssesmentCulegAPI.cariData(cu, periode);
    ...
    async count() {
      ...
      try {
        const response = await AssesmentCulegAPI.count();
