...
import FasilitatorAPI from '../api/fasilitator.js';

export const useFasilitatorStore = defineStore('fasilitator', {
  state: () => ({
    data: {}, //single data
    dataS: [], //collection
    dataS2: [], //collection
  ...
  actions: {
    ...
    async index(p) {
      ...
      try {
        const response = await FasilitatorAPI.index(p);
    ...
    async indexCu([p, id]) {
      ...
      try {
        const response = await FasilitatorAPI.indexCu(p, id);
        this.dataS = response.data.model;
        this.dataStatS = 'success';
      } catch (error) {
        this.dataS = error.response;
    ...
    async indexDiklat(id) {
      ...
      try {
        const response = await FasilitatorAPI.indexDiklat(id);
    ...
    async get() {
      ...
      try {
        const response = await FasilitatorAPI.get();
        this.dataS = response.data.model;
        this.dataStatS = 'success';
      } catch (error) {
        this.dataS = error.response;
    ...
    async getCu(id) {
      ...
      try {
        const response = await FasilitatorAPI.getCu(id);
        this.dataS = response.data.model;
        this.dataStatS = 'success';
      } catch (error) {
        this.dataS = error.response;
    ...
    async create() {
      ...
      try {
        const response = await FasilitatorAPI.create();
    ...
    async store(form) {
      ...
      try {
        const response = await FasilitatorAPI.store(form);
    ...
    async edit(id) {
      ...
      try {
        const response = await FasilitatorAPI.edit(id);
        this.data = response.data.form;
        this.rules = response.data.rules;
        this.options = response.data.options;
        this.dataStat = 'success';
    ...
    async update([id, form]) {
      ...
      try {
        const response = await FasilitatorAPI.update(id, form);
        if (response.data.saved) {
          this.update = response.data;
          this.updateStat = 'success';
        } else {
    ...
    async destroy(id) {
      ...
      try {
        const response = await FasilitatorAPI.destroy(id);
