...
import MentorAPI from '../api/mentor.js';
...
export const useMentorStore = defineStore('mentor', {
  ...
  actions: {
    ...
    async index(p) {
      ...
      try {
        const response = await MentorAPI.index(p);
    ...
    async indexCu([p, id]) {
      ...
      try {
        const response = await MentorAPI.indexCu(p, id);
        this.dataS = response.data.model;
        this.dataStatS = 'success';
      } catch (error) {
        this.dataS = error.response;
    ...
    async indexDiklat(id) {
      ...
      try {
        const response = await MentorAPI.indexDiklat(id);
    ...
    async get() {
      ...
      try {
        const response = await MentorAPI.get();
        this.dataS = response.data.model;
        this.dataStatS = 'success';
      } catch (error) {
        this.dataS = error.response;
    ...
    async getCu(id) {
      ...
      try {
        const response = await MentorAPI.getCu(id);
        this.dataS = response.data.model;
        this.dataStatS = 'success';
      } catch (error) {
        this.dataS = error.response;
    ...
    async edit(id) {
      ...
      try {
        const response = await MentorAPI.edit(id);
        this.data = response.data.form;
        this.rules = response.data.rules;
        this.options = response.data.options;
        this.dataStat = 'success';
