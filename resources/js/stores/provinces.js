...
export const useProvincesStore = defineStore('provinces', {
    ...
    actions: {
        ...
        async index(p) {
            ...
            try {
                const response = await ProvincesAPI.index(p);
        ...
        async create() {
            ...
            try {
                const response = await ProvincesAPI.create();
        ...
        async store(form) {
            ...
            try {
                const response = await ProvincesAPI.store(form);
        ...
        async edit(id) {
            this.dataStat = 'loading';
            try {
                const response = await ProvincesAPI.edit(id);
                this.data = response.data.form;
                this.rules = response.data.rules;
                this.options = response.data.options;
                this.dataStat = 'success';
        ...
        async update([id, form]) {
            this.updateStat = 'loading';
            try {
                const response = await ProvincesAPI.update(id, form);
                if (response.data.saved) {
                    this.updateData = response.data;
                    this.updateStat = 'success';
                } else {
        ...
        async destroy(id) {
            this.updateStat = 'loading';
            try {
                const response = await ProvincesAPI.destroy(id);
