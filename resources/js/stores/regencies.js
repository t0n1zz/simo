...
export const useRegenciesStore = defineStore('regencies', {
    state: () => ({
        data: {}, // single data
        dataS: [], // collection
        dataStat: '',
    ...
    actions: {
        ...
        async index(p) {
            ...
            try {
                const response = await RegenciesAPI.index(p);
        ...
        async get() {
            this.dataStatS = 'loading';
            try {
                const response = await RegenciesAPI.get();
                this.dataS = response.data.model;
                this.dataStatS = 'success';
            } catch (error) {
                this.dataS = error.response;
        ...
        async create() {
            ...
            try {
                const response = await RegenciesAPI.create();
        ...
        async edit(id) {
            this.dataStat = 'loading';
            try {
                const response = await RegenciesAPI.edit(id);
                this.data = response.data.form;
                this.rules = response.data.rules;
                this.options = response.data.options;
                this.dataStat = 'success';
