...
import UmkmAPI from '../api/umkm.js';
...
export const useUmkmStore = defineStore('umkm', {
  ...
  actions: {
    ...
    async index(p) {
      ...
      try {
        const response = await UmkmAPI.index(p);
    ...
    async indexCu([p, id]) {
      ...
      try {
        const response = await UmkmAPI.indexCu(p, id);
        this.dataS = response.data.model;
        this.dataStatS = 'success';
      } catch (error) {
        this.dataS = error.response;
    ...
    async indexDiklat(id) {
      ...
      try {
        const response = await UmkmAPI.indexDiklat(id);
    ...
    async get() {
      ...
      try {
        const response = await UmkmAPI.get();
        this.dataS = response.data.model;
        this.dataStatS = 'success';
      } catch (error) {
        this.dataS = error.response;
    ...
    async getCu(id) {
      ...
      try {
        const response = await UmkmAPI.getCu(id);
        this.dataS = response.data.model;
        this.dataStatS = 'success';
      } catch (error) {
        this.dataS = error.response;
    ...
    async create() {
      ...
      try {
        const response = await UmkmAPI.create();
    ...
    async store(form) {
      ...
      try {
        const response = await UmkmAPI.store(form);
    ...
    async edit(id) {
      ...
      try {
        const response = await UmkmAPI.edit(id);
        this.data = response.data.form;
        this.rules = response.data.rules;
        this.options = response.data.options;
        this.dataStat = 'success';
    ...
    async update([id, form]) {
      ...
      try {
        const response = await UmkmAPI.update(id, form);
        if (response.data.saved) {
          this.updateData = response.data;
          this.updateStat = 'success';
        } else {
    ...
    async destroy(id) {
      ...
      try {
        const response = await UmkmAPI.destroy(id);
