		...
		methods: {
			fetch(params){
				if(this.$route.params.cu == 'semua'){
					...
					this.artikelKategoriStore.index(params);
					this.excelDownloadUrl = this.kelas;
				}else{
					this.disableColumnCu(true);
					this.artikelKategoriStore.indexCu(params, this.$route.params.cu);
			...
			lihatArtikel(id, id_cu){
				this.artikelKategoriStore.resetDataStat();
			...
			modalTutup() {
				...
				this.artikelKategoriStore.resetUpdateStat();
			},
			modalConfirmOk() {
				if (this.state == 'hapus') {
					this.artikelKategoriStore.destroy(this.selectedItem.id);
				}
			}
		},
		computed: {
