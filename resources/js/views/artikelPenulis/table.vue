		...
		methods: {
			fetch(params){
				if(this.$route.params.cu == 'semua'){
					...
					this.artikelPenulisStore.index(params);
					this.excelDownloadUrl = this.kelas;
				}else{
					this.disableColumnCu(true);
					this.artikelPenulisStore.indexCu(params, this.$route.params.cu);
			...
			lihatArtikel(id, id_cu){
				this.artikelPenulisStore.resetDataStat();
			...
			modalTutup() {
				...
				this.artikelPenulisStore.resetUpdateStat();
			},
			modalConfirmOk() {
				if (this.state == 'hapus') {
					this.artikelPenulisStore.destroy(this.selectedItem.id);
				}
			}
		},
		computed: {
