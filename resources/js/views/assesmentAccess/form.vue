  ...
  methods: {
    fetch() {
      if (this.$route.meta.mode == "edit") {
        this.assesmentAccessStore.edit(this.$route.params.id);
        ...
        this.assesmentAccessStore.editPenilaian(this.$route.params.id);
        ...
        this.assesmentAccessStore.resetPeriode();
				this.assesmentAccessStore.create();
      }
    },
    changeCU(id) {
      this.form.id_cu = id;
