<template>
	<div>
				...
				<div class="row justify-content-between">
					...
					<div class="col-md-6 text-right">
						<ul class="list-inline mb-0 font-weight-bold">
							...
							<li>Skor PUSKOPCUINA: {{ skorBKCUA() }} / Bobot Skor PUSKOPCUINA: {{ bobotBKCUA() }}%</li>
						</ul>	
					</div>
				</div>
			</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan keterangan " v-model="form.p1.p1a1_bkcu_keterangan" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan rekomendasi " v-model="form.p1.p1a1_bkcu_rekomendasi" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
							</div>
						</div>
		...
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua') || form.p1.p1a2_cu_penilaian == cuTabName || form.p1.p1a2_bkcu_penilaian == bkcuTabName">
			<div class="card border-info" v-if="form.p1.p1a1_cu_penilaian !=null && form.p1.p1a1_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
				<div class="card-header bg-info text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p1.p1a2_cu_keterangan" :readonly="$route.meta.mode == 'penilaianBkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
						<!-- penilaian bkcu -->
						<div class="col-md-12" v-if="mode == 'penilaianBkcu' || mode == 'lihat'">
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan keterangan " v-model="form.p1.p1a2_bkcu_keterangan" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan rekomendasi " v-model="form.p1.p1a2_bkcu_rekomendasi" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
							</div>
						</div>
		...
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="cuTabName == 'semua' && bkcuTabName == 'semua'">
			<div class="card card-body bg-warning text-white" v-if="form.p1.p1a2_cu_penilaian !=null && form.p1.p1a2_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
				<div class="row justify-content-between">
					<div class="col-md-6">
					...
					<div class="col-md-6 text-right">
						<ul class="list-inline mb-0 font-weight-bold">
							...
							<li>Skor PUSKOPCUINA: {{ skorBKCUB() }} / Bobot Skor PUSKOPCUINA: {{ bobotBKCUB() }}% </li>
						</ul>	
					</div>
				</div>	
			</div>
		...
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua') || form.p1.p1b3_cu_penilaian == cuTabName || form.p1.p1b3_bkcu_penilaian == bkcuTabName">
			<div class="card border-warning" v-if="form.p1.p1a2_cu_penilaian !=null && form.p1.p1a2_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p1.p1b3_cu_keterangan" :readonly="$route.meta.mode == 'penilaianBkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan keterangan " v-model="form.p1.p1b3_bkcu_keterangan" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan rekomendasi " v-model="form.p1.p1b3_bkcu_rekomendasi" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
							</div>
						</div>
		...
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua') || form.p1.p1b4_cu_penilaian == cuTabName || form.p1.p1b4_bkcu_penilaian == bkcuTabName">
			<div class="card border-warning" v-if="form.p1.p1b3_cu_penilaian !=null && form.p1.p1b3_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
				<div class="card-header bg-warning text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p1.p1b4_cu_keterangan" :readonly="$route.meta.mode == 'penilaianBkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan keterangan " v-model="form.p1.p1b4_bkcu_keterangan" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan rekomendasi " v-model="form.p1.p1b4_bkcu_rekomendasi" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
							</div>
						</div>
		...
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua') || form.p1.p1b5_cu_penilaian == cuTabName || form.p1.p1b5_bkcu_penilaian == bkcuTabName">
			<div class="card border-warning" v-if="form.p1.p1b4_cu_penilaian !=null && form.p1.p1b4_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
				<div class="card-header bg-warning text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p1.p1b5_cu_keterangan" :readonly="$route.meta.mode == 'penilaianBkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan keterangan " v-model="form.p1.p1b5_bkcu_keterangan" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan rekomendasi " v-model="form.p1.p1b5_bkcu_rekomendasi" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
							</div>
						</div>
		...
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua') || form.p1.p1b7_cu_penilaian == cuTabName || form.p1.p1b7_bkcu_penilaian == bkcuTabName">
			<div class="card border-warning" v-if="form.p1.p1b5_cu_penilaian !=null && form.p1.p1b5_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
				<div class="card-header bg-warning text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p1.p1b7_cu_keterangan" :readonly="$route.meta.mode == 'penilaianBkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan keterangan " v-model="form.p1.p1b7_bkcu_keterangan" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan rekomendasi " v-model="form.p1.p1b7_bkcu_rekomendasi" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
							</div>
						</div>
		...
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua')">
			<div class="card card-body bg-success text-white" v-if="form.p1.p1b7_cu_penilaian !=null && form.p1.p1b7_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
				<div class="row justify-content-between">
					<div class="col-md-6">
					...
					<div class="col-md-6 text-right">
						<ul class="list-inline mb-0 font-weight-bold">
							...
							<li>Skor PUSKOPCUINA: {{ skorBKCUC() }} / Bobot Skor PUSKOPCUINA: {{ bobotBKCUC() }}% </li>
						</ul>	
					</div>
				</div>	
			</div>
		...
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua') || form.p1.p1c8_cu_penilaian == cuTabName || form.p1.p1c8_bkcu_penilaian == bkcuTabName">
			<div class="card border-success" v-if="form.p1.p1b7_cu_penilaian !=null && form.p1.p1b7_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p1.p1c8_cu_keterangan" :readonly="$route.meta.mode == 'penilaianBkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan keterangan " v-model="form.p1.p1c8_bkcu_keterangan" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan rekomendasi " v-model="form.p1.p1c8_bkcu_rekomendasi" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
							</div>
						</div>
		...
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua') || form.p1.p1c9_cu_penilaian == cuTabName || form.p1.p1c9_bkcu_penilaian == bkcuTabName">
			<div class="card border-success" v-if="form.p1.p1c8_cu_penilaian !=null && form.p1.p1c8_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
				<div class="card-header bg-success text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p1.p1c9_cu_keterangan" :readonly="$route.meta.mode == 'penilaianBkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan keterangan " v-model="form.p1.p1c9_bkcu_keterangan" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan rekomendasi " v-model="form.p1.p1c9_bkcu_rekomendasi" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
							</div>
						</div>
		...
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua')">
			<div class="card card-body bg-brown text-white" v-if="form.p1.p1c9_cu_penilaian !=null && form.p1.p1c9_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
				<div class="row justify-content-between">
					<div class="col-md-6">
					...
					<div class="col-md-6 text-right">
						<ul class="list-inline mb-0 font-weight-bold">
							...
							<li>Skor PUSKOPCUINA: {{ skorBKCUD() }} / Bobot Skor PUSKOPCUINA: {{ bobotBKCUD() }}% </li>
						</ul>	
					</div>
				</div>	
			</div>
		...
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua') || form.p1.p1d10_cu_penilaian == cuTabName || form.p1.p1d10_bkcu_penilaian == bkcuTabName">
			<div class="card border-brown" v-if="form.p1.p1c9_cu_penilaian !=null && form.p1.p1c9_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p1.p1d10_cu_keterangan" :readonly="$route.meta.mode == 'penilaianBkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan keterangan " v-model="form.p1.p1d10_bkcu_keterangan" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan rekomendasi " v-model="form.p1.p1d10_bkcu_rekomendasi" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
							</div>
						</div>
		...
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua') || form.p1.p1d11_cu_penilaian == cuTabName || form.p1.p1d11_bkcu_penilaian == bkcuTabName">
			<div class="card border-brown" v-if="form.p1.p1d10_cu_penilaian !=null && form.p1.p1d10_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
				<div class="card-header bg-brown text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p1.p1d11_cu_keterangan" :readonly="$route.meta.mode == 'penilaianBkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan keterangan " v-model="form.p1.p1d11_bkcu_keterangan" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan rekomendasi" v-model="form.p1.p1d11_bkcu_rekomendasi" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
							</div>
						</div>
		...
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="cuTabName == 'semua' && bkcuTabName == 'semua'">
			<div class="card card-body bg-danger text-white" v-if="form.p1.p1d11_cu_penilaian !=null && form.p1.p1d11_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
				<div class="row justify-content-between">
					<div class="col-md-6">
					...
					<div class="col-md-6 text-right">
						<ul class="list-inline mb-0 font-weight-bold">
							...
							<li>Skor PUSKOPCUINA: {{ skorBKCUE() }} / Bobot Skor PUSKOPCUINA: {{ bobotBKCUE() }}% </li>
						</ul>	
					</div>
				</div>	
			</div>
		...
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua') || form.p1.p1e12_cu_penilaian == cuTabName || form.p1.p1e12_bkcu_penilaian == bkcuTabName">
			<div class="card border-danger" v-if="form.p1.p1d11_cu_penilaian !=null && form.p1.p1d11_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p1.p1e12_cu_keterangan" :readonly="$route.meta.mode == 'penilaianBkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan keterangan " v-model="form.p1.p1e12_bkcu_keterangan" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan rekomendasi " v-model="form.p1.p1e12_bkcu_rekomendasi" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
							</div>
						</div>
		...
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="cuTabName == 'semua' && bkcuTabName == 'semua'">
			<div class="card card-body bg-teal text-white" v-if="form.p1.p1e12_cu_penilaian !=null && form.p1.p1e12_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
				<div class="row justify-content-between">
					<div class="col-md-6">
					...
					<div class="col-md-6 text-right">
						<ul class="list-inline mb-0 font-weight-bold">
							...
							<li>Skor PUSKOPCUINA: {{ skorBKCUF() }} / Bobot Skor PUSKOPCUINA: {{ bobotBKCUF() }}% </li>
						</ul>	
					</div>
				</div>	
			</div>
		...
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua') || form.p1.p1ff13_cu_penilaian == cuTabName || form.p1.p1ff13_bkcu_penilaian == bkcuTabName">
			<div class="card border-teal" v-if="form.p1.p1e12_cu_penilaian !=null && form.p1.p1e12_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p1.p1f13_cu_keterangan" :readonly="$route.meta.mode == 'penilaianBkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan keterangan " v-model="form.p1.p1f13_bkcu_keterangan" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan rekomendasi " v-model="form.p1.p1f13_bkcu_rekomendasi" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
							</div>
						</div>
		...
		<div v-show="(cuTabName == 'semua' && bkcuTabName == 'semua') || form.p1.p1f14_cu_penilaian == cuTabName || form.p1.p1f14_bkcu_penilaian == bkcuTabName">
			<div class="card border-teal" v-if="form.p1.p1f13_cu_penilaian !=null && form.p1.p1f13_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
				<div class="card-header bg-teal text-white">
					<h5 class="card-title">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								class="form-control"
								placeholder="Silahkan masukkan keterangan " v-model="form.p1.p1f14_cu_keterangan" :readonly="$route.meta.mode == 'penilaianBkcu' || $route.meta.mode == 'lihat'"></textarea>
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan keterangan " v-model="form.p1.p1f14_bkcu_keterangan" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										class="form-control"
										placeholder="Silahkan masukkan rekomendasi " v-model="form.p1.p1f14_bkcu_rekomendasi" :readonly="$route.meta.mode == 'lihat'"></textarea>
									</div>
								</div>
							</div>
						</div>
		...
		<transition enter-active-class="animated fadeIn" mode="out-in">
		<div v-show="cuTabName == 'semua' && bkcuTabName == 'semua'">
			<div class="card card-body" v-if="form.p1.p1f14_cu_penilaian !=null && form.p1.p1f14_cu_keterangan !=null || (mode == 'penilaianBkcu' || mode == 'lihat')">
...
<script>
	...
	import { month, year, percentage2, currency, round } from '../../helpers/filterHelpers';
	...
	export default {
		...
		methods: {
			...
			bobotCUA(){
				var jumlah = round((((this.form.p1.p1a1_cu_penilaian + this.form.p1.p1a2_cu_penilaian) / this.jumlahIndikator) * this.bobotSkor),2);
			...
			bobotBKCUA(){
				var jumlah = round((((this.form.p1.p1a1_bkcu_penilaian + this.form.p1.p1a2_bkcu_penilaian) / this.jumlahIndikator) * this.bobotSkor),2);
			...
			bobotCUB(){
				var jumlah = round((((this.form.p1.p1b3_cu_penilaian + this.form.p1.p1b4_cu_penilaian + this.form.p1.p1b5_cu_penilaian + this.form.p1.p1b7_cu_penilaian) / this.jumlahIndikator) * this.bobotSkor),2);
			...
			bobotBKCUB(){
				var jumlah = round((((this.form.p1.p1b3_bkcu_penilaian + this.form.p1.p1b4_bkcu_penilaian + this.form.p1.p1b5_bkcu_penilaian + this.form.p1.p1b7_bkcu_penilaian) / this.jumlahIndikator) * this.bobotSkor),2);
			...
			bobotCUC(){
				var jumlah = round((((this.form.p1.p1c8_cu_penilaian + this.form.p1.p1c9_cu_penilaian) / this.jumlahIndikator) * this.bobotSkor),2);
			...
			bobotBKCUC(){
				var jumlah = round((((this.form.p1.p1c8_bkcu_penilaian + this.form.p1.p1c9_bkcu_penilaian) / this.jumlahIndikator) * this.bobotSkor),2);
			...
			bobotCUD(){
				var jumlah = round((((this.form.p1.p1d10_cu_penilaian + this.form.p1.p1d11_cu_penilaian) / this.jumlahIndikator) * this.bobotSkor),2);
			...
			bobotBKCUD(){
				var jumlah = round((((this.form.p1.p1d10_bkcu_penilaian + this.form.p1.p1d11_bkcu_penilaian) / this.jumlahIndikator) * this.bobotSkor),2);
			...
			bobotCUE(){
				var jumlah = round((((this.form.p1.p1e12_cu_penilaian) / this.jumlahIndikator) * this.bobotSkor),2);
			...
			bobotBKCUE(){
				var jumlah = round((((this.form.p1.p1e12_bkcu_penilaian) / this.jumlahIndikator) * this.bobotSkor),2);
			...
			bobotCUF(){
				var jumlah = round((((this.form.p1.p1f13_cu_penilaian + this.form.p1.p1f14_cu_penilaian) / this.jumlahIndikator) * this.bobotSkor),2);
			...
			bobotBKCUF(){
				var jumlah = round((((this.form.p1.p1f13_bkcu_penilaian + this.form.p1.p1f14_bkcu_penilaian) / this.jumlahIndikator) * this.bobotSkor),2);
