...
import { useAssesmentCulegStore } from "../../stores/assesmentCuleg";
...
export default {
  ...
  methods: {
    fetch() {
      if (this.$route.meta.mode == "edit") {
        this.assesmentCulegStore.edit(this.$route.params.id);
        ...
        this.assesmentCulegStore.editPenilaian(this.$route.params.id);
        ...
        this.assesmentCulegStore.resetPeriode();
        this.assesmentCulegStore.create();
      }
    },
    changeCU(id) {
      this.form.id_cu = id;
      this.laporanCuStore.getPeriodeCu(id);
    },
    changePeriode(id) {
      let _periode = "";
      ...
      this.assesmentCulegStore.cariData([this.form.id_cu, this.form.periode]);
  ...
  computed: {
    ...
    form() {
      return this.assesmentCulegStore.data;
    },
    formStat() {
      return this.assesmentCulegStore.dataStat;
    },
    rules() {
      return this.assesmentCulegStore.rules;
    },
    options() {
    ...
    updateSingleResponse() {
      return this.assesmentCulegStore.updateSingle;
    },
    updateSingleStat() {
      return this.assesmentCulegStore.updateSingleStat;
    },
    periode() {
      return this.assesmentCulegStore.periode;
    },
    periodeStat() {
      return this.assesmentCulegStore.periodeStat;
    },
    modelCU() {
