                  ...
                  <div class="col-sm-6">
                    <ul class="list list-unstyled mb-0">
                      <li>
                        ...
                        <span v-html="$filters.date(selectedData.tanggal_mati)"></span>
                      </li>
                      <li>
                        <b>Tanggal buat/pengajuan:</b> <br/>
                        <span v-html="$filters.dateTime(selectedData.created_at)"></span>
                      </li>
                      <li>
                        <b>Tanggal ubah:</b> <br/>
                        <span v-html="$filters.dateTime(selectedData.updated_at)"></span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div class="media mb-2">
                    <div class="media-body">
                      ...
                      <span class="opacity-75"><b>Usia Saat membuka:</b> 
                        <span v-if="item.tanggal" v-html="$filters.ageDiff(item.tanggal,selectedData.anggota_cu.tanggal_lahir)">
                        </span>
                        <span v-else>-</span>
                      </span>
                    </div>
              ...
              <div class="card card-body bg-teal-400" >
                <div class="media">
                  <div class="media-body">
                    ...
                    <span>
                      Tanggal Masuk CU: <span v-if="selectedData.anggota_cu_cu.tanggal_masuk" v-html="$filters.date(selectedData.anggota_cu_cu.tanggal_masuk)"></span> 
                    </span>
                  </div>   
                </div>
              </div>
                ...
                <div class="media">
                  <div class="media-body">
                    <div v-if="selectedData.tipe == 'CACAT'">
                      ...
                      <span>
                        Tanggal Cacat: <span v-if="selectedData.tanggal_mati" v-html="$filters.date(selectedData.tanggal_mati)"></span> 
                      </span>
                    </div>
                    <div v-else-if="selectedData.tipe == 'MENINGGAL'">
                      ...
                      <span>
                        Tanggal Meninggal: <span v-if="selectedData.tanggal_mati" v-html="$filters.date(selectedData.tanggal_mati)"></span> 
                      </span>
                    </div>
                  </div>   
                </div>
                ...
                <div class="media">
                  <div class="media-body">
                    <div v-if="selectedData.tipe == 'CACAT'">
                      ...
                      <span>
                        Tanggal Cacat: <span v-if="selectedData.anggota_cu.tanggal_cacat" v-html="$filters.date(selectedData.anggota_cu.tanggal_cacat)"></span> 
                      </span>
                    </div>
                    <div v-else-if="selectedData.tipe == 'MENINGGAL'">
                      <h3 class="mb-0" >Usia Meninggal: 
                      ...
                      <span>
                        Tanggal Meninggal: <span v-if="selectedData.anggota_cu.tanggal_meninggal" v-html="$filters.date(selectedData.anggota_cu.tanggal_meninggal)"></span> 
                      </span>
                    </div>
                  </div>   
                </div>
...
<script>
  ...
  import DatePicker from "../../components/datePicker.vue";
	...
	export default {
      ...
      this.indexProduk([this.selectedData.anggota_cu_id, this.selectedData.anggota_cu_cu.cu_id]); 
      this.getDuplicate([this.selectedData.anggota_cu.name,this.selectedData.anggota_cu.tanggal_lahir, this.selectedData.tipe]);
      this.getKlaimLama([this.selectedData.anggota_cu.nik.trim(),this.selectedData.anggota_cu_cu_id]);
		},
		watch: {
		},
		methods: {
      ...mapActions(useJalinanKlaimStore, ['getDuplicate', 'getKlaimLama', 'getHistory', 'getVerifikator', 'updateSelesai', 'updateVerifikasi', 'updateStatus']),
      ...mapActions(useAnggotaCuStore, ['resetDataProdukSaldo', 'indexProduk']),
      ...mapActions(useUserStore, ['indexCuPermission']),
      selectedRow(item) {
      ...
      changeTab(value) {
          ...
          this.isHistory = true
           this.getHistory(this.selectedData.id);
        }
      },
      ...
      fetchVerifikator(){
        ...
        this.indexCuPermission(this.selectedData.anggota_cu_cu.cu_id);
      ...
      save(){
        ...
        if(this.tipe == 'selesai'){
          this.updateSelesai(this.selected.id);
