          ...
          <div class="row justify-content-between ml-3 mr-3">
            ...
            <div class="col-5 text-right">
              <ul class="list list-unstyled mb-0">
                ...
                <li class="mt-0" v-html="$filters.dateMonth(selectedItem.surat_tanggal)" v-if="selectedItem.surat_tanggal"></li>
              </ul>
            </div>
            ...
            <div class="col-12">
              <ul class="list list-unstyled mb-0">
                ...
                <li>
                  {{ capitalize(modelProvinces.name + ',') }} 
                  {{ capitalize(modelRegencies.name + ',') }} 
                  {{ capitalize(modelDistricts.name + ',') }}  
                  {{ capitalize(modelVillages.name) }}</li>
              </ul>
            </div>
...
<script type="text/javascript">
  ...
  export default {
    ...
    created(){
      this.editProvinces(this.selectedItem.anggota_cu_cu.cu.id_provinces);
      this.editRegencies(this.selectedItem.anggota_cu_cu.cu.id_regencies);
      this.editDistricts(this.selectedItem.anggota_cu_cu.cu.id_districts);
      this.editVillages(this.selectedItem.anggota_cu_cu.cu.id_villages);
    },
    methods: {
      ...mapActions(useProvincesStore, { editProvinces: 'edit' }),
      ...mapActions(useRegenciesStore, { editRegencies: 'edit' }),
      ...mapActions(useDistrictsStore, { editDistricts: 'edit' }),
      ...mapActions(useVillagesStore, { editVillages: 'edit' }),
      print(){
