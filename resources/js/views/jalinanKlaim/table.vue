<template>
  <div>
    ...
    <data-viewer :title="title" :columnData="columnData" :itemData="itemData" :query="query" :itemDataStat="itemDataStat" :excelDownloadUrl="excelDownloadUrl" @fetch="fetch">
      ...
      <!-- button desktop -->
      <template #button-desktop v-if="!isSimple">
      ...
      <!-- button mobile -->
      <template #button-mobile v-if="!isSimple">
      ...
      <template #item-desktop="props">
          ...
          <td v-if="!columnData[2].hide && !columnData[2].disable">
						<check-value :value="props.item.surat_nomor"></check-value>
					</td>
          ...
          <td v-if="!columnData[10].hide && !columnData[10].disable">
						<span v-html="$filters.checkStatus(props.item.verifikasi_pengurus)"></span>
					</td>
          <td v-if="!columnData[11].hide && !columnData[11].disable">
						<span v-html="$filters.checkStatus(props.item.verifikasi_pengawas)"></span>
					</td>
           <td v-if="!columnData[12].hide && !columnData[12].disable">
						<span v-html="$filters.checkStatus(props.item.verifikasi_manajemen)"></span>
					</td>
          ...
          <td v-if="!columnData[16].hide && !columnData[16].disable">
           ...
           <td v-if="!columnData[17].hide && !columnData[17].disable">
            <check-value :value="props.item.lintang_disetujui" valueType="currency"></check-value>
					</td>
          <td v-if="!columnData[18].hide" v-html="$filters.date(props.item.tanggal_mati)" class="text-nowrap"></td>
          <td v-if="!columnData[19].hide" v-html="$filters.date(props.item.anggota_cu ? props.item.anggota_cu.tanggal_lahir : '')" class="text-nowrap"></td>
          <td v-if="!columnData[20].hide" v-html="$filters.date(props.item.anggota_cu_cu? props.item.anggota_cu_cu.tanggal_masuk : '')" class="text-nowrap"></td>
          <td v-if="!columnData[21].hide && !columnData[21].disable" v-html="$filters.date(props.item.tanggal_pencairan)" class="text-nowrap"></td>
          ...
          <td v-if="!columnData[26].hide">
						<check-value :value="props.item.pinjaman_anggota_terakhir.saldo" v-if="props.item.pinjaman_anggota_terakhir" valueType="currency"></check-value>
            <span v-else>-</span>
					</td>
          <td v-if="!columnData[27].hide">
						<check-value :value="props.item.pinjaman_anggota_terakhir.lama_pinjaman" v-if="props.item.pinjaman_anggota_terakhir"></check-value>
            <span v-else>-</span>
					</td>
          <td v-if="!columnData[28].hide">
            <span v-html="$filters.date(props.item.pinjaman_anggota_terakhir.tanggal)" v-if="props.item.pinjaman_anggota_terakhir"></span>
            <span v-else>-</span>
					</td>
          ...
          <td v-if="!columnData[34].hide">
					...
					<td v-if="!columnData[35].hide" v-html="$filters.dateTime(props.item.created_at)" class="text-nowrap"></td>
