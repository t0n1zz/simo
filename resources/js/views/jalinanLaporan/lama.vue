				...
				<div class="content-wrapper">
					<div class="content">
						...
						<div v-if="$route.meta.mode == 'laporan'">
							...
							<table-kelompok :title="'Bantuan Solidaritas Per Lama'" :itemData="itemData" :itemDataStat="itemDataStat" :url="url" :isCu="false" @bukaData="bukaData" @lihatSemua="bukaData"></table-kelompok>
