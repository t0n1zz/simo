...
<script>
  ...
  export default {
    ...
    methods: {
      ...mapActions(useJalinanKlaimStore, {indexLaporanCu: 'indexLaporanCu'}),
      fetch(){
        if(this.$route.params.cu == 'semua'){
          if(this.isCu){
            this.columnData = [ 
        ...
        this.indexLaporanCu([this.$route.params.status, this.$route.params.cu, this.$route.params.awal, this.$route.params.akhir]);
      },
      selectedRow(item) {
