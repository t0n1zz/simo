    ...
    <data-viewer :title="'peserta terdaftar'" :itemData="itemDataPesertaHadir" :columnData="columnDataPesertaHadir" :itemDataStat="itemDataPesertaHadirStat" :query="queryPesertaHadir" @fetch="fetchPesertaHadir" :excelDownloadUrl="excelDownloadUrl" :isDasar="'true'" :isNoKolom="'true'" :isDisable="isDisableTable">
      ...
      <template #item-desktop="props">
        <tr class="text-nowrap" v-if="props.item">
					...
					<td v-if="!columnDataPesertaHadir[7].hide" v-html="$filters.dateTime(props.item.tanggal_hadir)">
					</td>
					...
					<td v-if="props.item.aktivis && !columnDataPesertaHadir[15].hide" v-html="$filters.date(props.item.aktivis.tanggal_lahir)">
					</td>
					...
					<td v-if="props.item.aktivis && !columnDataPesertaHadir[22].hide" v-html="$filters.dateTime(props.item.created_at)">
					</td>
				</tr>
      </template>	
    </data-viewer>
  ...
  import dataViewer from '../../components/dataviewer2.vue';
	...
	export default {
      ...
      ...mapActions(useKegiatanBKCUStore, {
        indexPesertaHadirAct: 'indexPesertaHadir'
      }),
      fetchPesertaHadir(params){
				this.indexPesertaHadirAct([params,this.item.id]);
