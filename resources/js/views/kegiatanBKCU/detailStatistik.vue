  ...
  import checkValue from '../../components/checkValue.vue';
	...
	export default {
      ...
      ...mapActions(useKegiatanBKCUStore, {
        indexPesertaCountCu: 'indexPesertaCountCu',
        indexPesertaHadirCountCu: 'indexPesertaHadirCountCu'
      }),
      fetchStatistik(){
				this.indexPesertaCountCu(this.item.id);
				this.indexPesertaHadirCountCu(this.item.id);
			},
		},
		computed: {
