<template>
	<div>
		<!-- message -->
		<message v-if="errors && errors.any && errors.any('formRekom') && submited" :title="'Oops, terjadi kesalahan'" :errorItem="errors && errors.items">
		</message>

		<form @submit.prevent="save" enctype="multipart/form-data" data-vv-scope="formRekom">

			<div class="form-group" :class="{'has-error' : errors && errors.has && errors.has('formRekom.name')}">
				<!-- title -->
				<h5 :class="{ 'text-danger' : errors && errors.has && errors.has('formRekom.no')}">
					<i class="icon-cross2" v-if="errors && errors.has && errors.has('formRekom.no')"></i>
				...
				<!-- error message -->
				<small class="text-muted text-danger" v-if="errors && errors.has && errors.has('formRekom.no')">
					<i class="icon-arrow-small-right"></i> {{ errors && errors.first && errors.first('formRekom.no') }}
				</small>
      ...
      <!-- name -->
			<div class="form-group" :class="{'has-error' : errors && errors.has && errors.has('formRekom.name')}">
				...
				<!-- title -->
				<h5 :class="{ 'text-danger' : errors && errors.has && errors.has('formRekom.name')}">
					<i class="icon-cross2" v-if="errors && errors.has && errors.has('formRekom.name')"></i>
        ...
        <textarea rows="5" type="text" name="rekomendasi" class="form-control" placeholder="Silahkan masukkan rekomendasi " v-validate="'required'" data-vv-as="Rekomendasi" v-model="formRekom.name"></textarea>
				...
				<!-- error message -->
				<small class="text-muted text-danger" v-if="errors && errors.has && errors.has('formRekom.name')">
					<i class="icon-arrow-small-right"></i> {{ errors && errors.first && errors.first('formRekom.name') }}
				</small>
				<small class="text-muted" v-else>&nbsp;
				</small>
			</div>
			...
			<div class="form-group" :class="{'has-error' : errors && errors.has && errors.has('formRekom.tipe')}">
				<!-- title -->
				<h5>
					<i class="icon-cross2" v-if="errors && errors.has && errors.has('formRekom.tipe')"></i>Tipe Tindak Lanjut <wajib-badge></wajib-badge>
				</h5>
				...
				<!-- error message -->
				<small class="text-muted text-danger" v-if="errors && errors.has && errors.has('formRekom.tipe')">
					<i class="icon-arrow-small-right"></i> {{ errors && errors.first && errors.first('formRekom.tipe') }}
				</small>
				<small class="text-muted" v-else>&nbsp;
				</small>
			</div>
