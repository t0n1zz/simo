            ...
            <div class="d-none d-sm-block">
              <div class="header-elements">
                <span class="badge badge-secondary">
                  <small v-html="$filters.dateTime(jawaban.created_at)"></small>	
                </span>
	...
	export default {
      ...
      updateStat(value) {
		...
		methods: {
			...mapActions(useKegiatanBKCUStore, {
				editTugasJawaban: 'editTugasJawaban',
				indexTugasJawaban: 'indexTugasJawaban',
				updateTugasJawaban: 'updateTugasJawaban',
				storeTugasJawaban: 'storeTugasJawaban',
				destroyTugasJawaban: 'destroyTugasJawaban',
			}),
      upload(e) {
      ...
      fetchJawaban(params){
        if(this.tipeUser == 'peserta'){
          this.editTugasJawaban(this.selected.id);
        }else{
      ...
      showOke(){
        if(this.isShowHapus){
          this.destroyTugasJawaban([this.kegiatan_tipe, this.selectedJawaban.id]);
        }
