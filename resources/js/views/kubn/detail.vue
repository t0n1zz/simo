...
<script>
	...
	export default {
		...
		methods: {
			fetch(){
				this.kubnStore.edit(this.$route.params.id);	
				this.kubnStore.indexAnggota(this.$route.params.id);	
				this.kubnStore.indexDiklat(this.$route.params.id);	
			},
		...
		computed:{
			...
			itemData() {
				return this.kubnStore.data;
			},
			itemDataStat() {
				return this.kubnStore.dataStat;
			},
			itemDataAnggota() {
				return this.kubnStore.dataS2;
			},
			itemDataStatAnggota() {
				return this.kubnStore.dataStatS2;
			},
			itemDataDiklat() {
				return this.kubnStore.dataS3;
			},
			itemDataStatDiklat() {
				return this.kubnStore.dataStatS3;
			},
			rules() {
				return this.kubnStore.rules;
			},
			options() {
