...
export default {
  ...
  methods: {
    ...mapActions(useLaporanCuStore, ['indexPeriode', 'indexCu', 'indexTp', 'indexTpPeriode', 'index', 'resetUpdateStat', 'destroy']),
    ...mapActions(useLaporanTpStore, {
      destroyTp: 'destroy',
      listLaporanTp: 'listLaporanTp'
    }),
    fetch(params) {
			var i;
			this.checkProfile();
    ...
    modalConfirmOk() {
      if (this.state == "hapus") {
        		...
        		this.destroyTp(this.selectedItem.id);
				 }else{
