...
import { dateMonth, month, percentage2, currency } from '../../helpers/filterHelpers';
...
export default {
  ...
  methods: {
    ...mapActions(useLaporanCuStore, ['indexPearlsPeriode', 'indexPearlsCu', 'indexPearlsTp', 'indexPearlsTpPeriode', 'indexPearls', 'resetUpdateStat', 'destroy']),
    fetch(params) {
