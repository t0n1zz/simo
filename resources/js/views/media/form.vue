								...
								<div class="row">
									...
									<div class="col-md-12">
										<div class="form-group">
											...
											<!-- imageupload -->
											<app-image-upload :image_loc="'/images/media/'" :image_temp="form.gambar"
									...
									<!-- link -->
									<div class="col-md-12">
										<div class="form-group" :class="{ 'has-error': errors.has('form.link') }">

											<!-- title -->
											<h5 :class="{ 'text-danger': errors.has('form.link') }">
												<i class="icon-cross2" v-if="errors.has('form.link')"></i>
												Link: <wajib-badge></wajib-badge>
											</h5>
											...
											<small class="text-muted text-danger" v-if="errors.has('form.link')">
												<i class="icon-arrow-small-right"></i> {{ errors.first('form.link') }}
											</small>
											<small class="text-muted" v-else>&nbsp;</small>
										</div>
									</div>
...
export default {
	...
	computed: {
		...
		...mapState(useArtikelPenulisStore, {
			form: 'data',
			formStat: 'dataStat',
			rules: 'rules',
			options: 'options',
