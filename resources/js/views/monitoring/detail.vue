		...
		<div class="page-content pt-0">
			<div class="content-wrapper">
				<div class="content">
					...
					<!-- message -->
					<message v-if="detailErrors.any('form') && submited" :title="'Oops terjadi kesalahan'" :errorItem="detailErrors.items">
					</message>
...
<script>
	...
	import { useMonitoringPencapaianStore } from '../../stores/monitoringPencapaian';
	...
	export default {
		...
		methods: {
			...mapActions(useMonitoringStore, ['edit', 'get', 'updateRekom']),
			...mapActions(useMonitoringPencapaianStore, { getPencapaian: 'get', destroyPencapaian: 'destroy' }),
			fetch() {
		...
		computed: {
			...
			...mapState(useMonitoringPencapaianStore, {
				itemData: 'dataS',
