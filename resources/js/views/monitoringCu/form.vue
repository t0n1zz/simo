						...
						<div class="card">
							<div class="card-body">
								...
								<div class="row">
									...
									<!-- PIC -->
									<div class="col-md-6">
										<div class="form-group" :class="{'has-error' : errors.has('form.id_aktivis_pic')}">

											<!-- title -->
											<h5 :class="{ 'text-danger' : errors.has('form.id_aktivis_pic')}">
												<i class="icon-cross2" v-if="errors.has('form.id_aktivis_pic')"></i>
												PIC: <wajib-badge></wajib-badge>
											</h5>
											...
											<small class="text-muted text-danger" v-if="errors.has('form.id_aktivis_pic')">
												<i class="icon-arrow-small-right"></i> {{ errors.first('form.id_aktivis_pic') }}
											</small>
											<small class="text-muted" v-else>&nbsp;</small>
										</div>
									</div>
									...
									<!-- Pemeriksa -->
									<div class="col-md-6">
										<div class="form-group" :class="{'has-error' : errors.has('form.id_aktivis_pemeriksa')}">

											<!-- title -->
											<h5 :class="{ 'text-danger' : errors.has('form.id_aktivis_pemeriksa')}">
												<i class="icon-cross2" v-if="errors.has('form.id_aktivis_pemeriksa')"></i>
												Pemeriksa: <wajib-badge></wajib-badge>
											</h5>
											...
											<small class="text-muted text-danger" v-if="errors.has('form.id_aktivis_pemeriksa')">
												<i class="icon-arrow-small-right"></i> {{ errors.first('form.id_aktivis_pemeriksa') }}
											</small>
											<small class="text-muted" v-else>&nbsp;</small>
										</div>
									</div>
...
<script>
	...
	export default {
		...
		data() {
			return {
				title: 'Tambah Temuan CU',
				titleDesc: 'Menambah temuan CU',
		...
		methods: {
			...mapActions(useMonitoringCuStore, ['create', 'edit', 'store', 'update', 'resetUpdateStat']),
			...mapActions(useCuStore, {getHeader: 'getHeader'}),
			...mapActions(useTpStore, {getCu: 'getCu'}),
			...mapActions(useAktivisStore, {resetDataS: 'resetDataS', getMonitoringCu: 'getMonitoringCu'}),
			fetch(){
				if(this.currentUser.id_cu == 0){
					if(this.modelCuStat != 'success'){
						this.getHeader();
