...
export default {
  ...
  methods: {
      downloadLaporan() {
          // this.$emit('loading');
          axios.post('/api/monitoringCu/laporan', { id_cu: this.id_cu, id_tp: this.id_tp, tgl_mulai: this.tanggal_mulai, tgl_akhir: this.tanggal_akhir, params: this.params, semua: this.semua }, {
              responseType: 'blob'
          }).then((response) => {
              this.$emit('stat');
