...
export default {
	...
	methods: {
		...mapActions(useMonitoringCuStore, ['indexKonsolidasi', 'resetUpdateStat']),
		roundedValue(a, b) {
			const diff = a - b;
		...
		fetch(params) {
			...
			this.indexKonsolidasi([params, this.$route.params.tahun, this.$route.params.bulan])
