					...
					<div class="card border-left-3 rounded-left-0" :class="[gridColor(props.item.tipe)]">
						<div class="card-header bg-light header-elements-inline">
							...
							<div class="header-elements">
								<span v-html="$filters.tipeProdukCu(props.item.tipe)"></span>
							</div>
						</div>
						<div class="card-body">
							<div class="row">
						...
						<div class="card-footer d-sm-flex justify-content-sm-between align-items-sm-center">
							<ul class="list-inline list-inline-dotted mb-1">
								<li class="list-inline-item"><strong>{{columnData[11].title}}:</strong> &nbsp; <span v-html="$filters.dateTime(props.item.created_at)"></span></li>
								<li class="list-inline-item" v-if="props.item.created_at !== props.item.updated_at"><strong>{{columnData[12].title}}:</strong> &nbsp; <span v-html="$filters.dateTime(props.item.updated_at)"></span></li>
							</ul>
...
<script>
	...
	import { useGlobalStore } from '../../stores/global'; // Assuming this exists, based on usage
	...
	export default {
      ...
      updateStat(value) {
		...
		methods: {
			...mapActions(useProdukCuStore, ['index', 'indexCu', 'resetUpdateStat', 'destroy']),
			fetch(params){
