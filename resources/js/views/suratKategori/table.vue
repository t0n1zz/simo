		...
		methods: {
			fetch(params){
				if(this.$route.params.cu == 'semua'){
					this.suratKategoriStore.index(params);
					this.excelDownloadUrl = this.kelas;
				}else{
					this.suratKategoriStore.indexCu([params,this.$route.params.cu]);
			...
			modalTutup() {
				...
				this.suratKategoriStore.resetUpdateStat();
			},
			modalConfirmOk() {
				if (this.state == 'hapus') {
					this.suratKategoriStore.destroy(this.selectedItem.id);
				}
			}
		},
		computed: {
