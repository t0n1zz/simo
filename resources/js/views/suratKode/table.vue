		...
		methods: {
			fetch(params){
				if(this.$route.params.cu == 'semua'){
					this.suratKodeStore.index(params);
					this.excelDownloadUrl = this.kelas;
				}else{
					this.suratKodeStore.indexCu([params,this.$route.params.cu]);
			...
			modalTutup() {
				...
				this.suratKodeStore.resetUpdateStat();
			},
			modalConfirmOk() {
				if (this.state == 'hapus') {
					this.suratKodeStore.destroy(this.selectedItem.id);
				}
			}
		},
		computed: {
