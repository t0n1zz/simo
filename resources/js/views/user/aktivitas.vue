									...
									<div class="row">
										<div class="col-sm-6">
											<ul class="list list-unstyled mb-0">
												...
												<li><b>Tingkat:</b> 
													<span v-if="itemData.aktivis && itemData.aktivis.pekerjaan_aktif" v-html="$filters.checkTingkatAktivis(itemData.aktivis.pekerjaan_aktif.tingkat)"></span>
													<span v-else>-</span>
												</li>
												<li><b>Jabatan:</b>
										...
										<div class="col-sm-6">
											<ul class="list list-unstyled mb-0">
												...
												<li><b>Login:</b> <span v-html="$filters.dateTime(itemData.login)"></span></li>
												<li><b>Tgl. Buat:</b> <span v-html="$filters.dateTime(itemData.created_at)"></span></li>
												<li><b>Tgl. Ubah:</b> <span v-html="$filters.dateTime(itemData.updated_at)"></span></li>
											</ul>
										</div>
									</div>
...
<script>
	...
	export default {
		...
		methods: {
			fetch(){
				this.userStore.edit(this.$route.params.id);	
			},
			fetchAktivitas(value){
				this.userStore.getActivity([value, this.itemData.id]);
			},
			back(){
