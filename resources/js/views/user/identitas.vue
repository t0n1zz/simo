          ...
          <div class="row">
            <div class="col-sm-6">
              <ul class="list list-unstyled mb-0">
                ...
                <li>
                  <b>Tgl. Lahir:</b>
                  <span v-if="itemData.tanggal_lahir" v-html="$filters.date(itemData.tanggal_lahir)"></span>
                  <span v-else>-</span>
                </li>
                <li>
                  <b>Status:</b>
            ...
            <div class="col-sm-6">
              <ul class="list list-unstyled mb-0">
                ...
                <li>
                  <b>Tingkat:</b>
                  {{ itemData.pekerjaan_aktif ? $filters.checkTingkatAktivis(itemData.pekerjaan_aktif.tingkat) : ''}}
                </li>
                <li>
                  <b>Jabatan:</b>
