...
@section('css')
<link rel="stylesheet" href="{{ asset('css/public/article-content.css') }}">
@stop
          ...
          <div class="entry">
            ...
            <div class="entry-meta d-flex justify-content-between mb-4">
              <ul>
                ...
                @endif
                <li>{{ $artikel->created_at->format('j F Y') }}</li>
              </ul>
              <ul>
                @if($artikel->kategori)
                  <li><a href="{{ route('artikel.kategori.cu',['cu'=>$subdomain,'slug'=>$artikel->kategori->slug]) }}" class="btn btn-primary text-white"><i class="bi-bookmark"></i> {{ $artikel->kategori->name }}</a></li>
                @endif
              </ul>
            </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col">
                      <div class="d-flex align-items-start mb-2">
                        ...
                        <a href="{{ route('artikel.penulis.cu',['cu'=>$subdomain,'slug'=>$artikel->penulis->slug]) }}" class="btn btn-light btn-sm rounded-pill px-3 ms-auto">BACA POSTINGAN LAINNYA</a>
                      </div>
                  ...
                  <div class="grid-inner row align-items-center no-gutter">
                    ...
                    <div class="col ps-3">
                      <div class="entry-title">
                        <h4 class="fw-medium"><a href="{{ route('artikel.lihat.cu',['cu'=>$subdomain,'slug'=>$item->slug]) }}">{{ $item->name }}</a></h4>
                      </div>
